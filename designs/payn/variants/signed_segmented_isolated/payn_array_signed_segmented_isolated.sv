`ifndef PAYN_SIGNED_SEGMENTED_ISOLATED_ARRAY
`define PAYN_SIGNED_SEGMENTED_ISOLATED_ARRAY
...
module payn_array_signed_segmented_isolated #(
    ...
    InnerPESignedSegmentedIsolatedFlat #(
