`ifndef PAYN_SIGNED_SEGMENTED_CENTERED_ARRAY
`define PAYN_SIGNED_SEGMENTED_CENTERED_ARRAY

`timescale 1ns/1ps

`include "payn/sobol.sv"
`include "payn/pe_peripheral.sv"
`include "payn/variants/signed_segmented_centered/inner_pe_signed_segmented_centered.sv"
...
module payn_array_signed_segmented_centered #(
    ...
    InnerPESignedSegmentedCenteredFlat #(
