`ifndef PAYN_WDBI_COUNTCORRECT_ARRAY
`define PAYN_WDBI_COUNTCORRECT_ARRAY

`timescale 1ns/1ps

`include "payn/sobol.sv"
`include "payn/pe_peripheral.sv"
`include "payn/variants/wdbi/countcorrect/inner_pe_wdbi_countcorrect.sv"
...
// W-only temporal DBI with shared A-popcount correction at each receiver row.
module payn_array_wdbi_countcorrect #(
