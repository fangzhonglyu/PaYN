`ifndef PAYN_WDBI_BITDECODE_ARRAY
`define PAYN_WDBI_BITDECODE_ARRAY

`timescale 1ns/1ps

`include "payn/sobol.sv"
`include "payn/pe_peripheral.sv"
`include "payn/variants/wdbi/bitdecode/inner_pe_wdbi_bitdecode.sv"
...
// W-only temporal DBI with a bitwise receiver decoder.  This is a distinct
// architectural top so the baseline payn_array remains free of mode switches.
module payn_array_wdbi_bitdecode #(
