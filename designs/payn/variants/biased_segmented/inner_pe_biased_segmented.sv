`ifndef PAYN_BIASED_SEGMENTED_INNER_PE
`define PAYN_BIASED_SEGMENTED_INNER_PE

`include "payn/variants/biased_segmented/inner_tile_biased_segmented.sv"

module InnerPEBiasedSegmented #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
...
module InnerPEBiasedSegmentedFlat #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
