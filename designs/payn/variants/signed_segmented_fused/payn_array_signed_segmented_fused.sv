`ifndef PAYN_SIGNED_SEGMENTED_FUSED_ARRAY
`define PAYN_SIGNED_SEGMENTED_FUSED_ARRAY

`timescale 1ns/1ps

`include "payn/sobol.sv"
`include "payn/pe_peripheral.sv"
`include "payn/variants/signed_segmented_fused/inner_pe_signed_segmented_fused.sv"
...
`define PAYN_NW 9
`endif
`ifndef PAYN_FUSED_SEG_LOW_W
`define PAYN_FUSED_SEG_LOW_W 9
`endif

module payn_array_signed_segmented_fused #(
    ...
    parameter int LOW_W = `PAYN_FUSED_SEG_LOW_W,
    ...
    InnerPESignedSegmentedFusedFlat #(
