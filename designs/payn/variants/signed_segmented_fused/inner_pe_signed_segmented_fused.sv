`ifndef PAYN_SIGNED_SEGMENTED_FUSED_INNER_PE
`define PAYN_SIGNED_SEGMENTED_FUSED_INNER_PE

`include "payn/variants/signed_segmented_fused/inner_tile_signed_segmented_fused.sv"

module InnerPESignedSegmentedFused #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
...
module InnerPESignedSegmentedFusedFlat #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
