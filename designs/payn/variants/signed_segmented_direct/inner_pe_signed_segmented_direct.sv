`ifndef PAYN_SIGNED_SEGMENTED_DIRECT_INNER_PE
`define PAYN_SIGNED_SEGMENTED_DIRECT_INNER_PE

`include "payn/variants/signed_segmented_direct/inner_tile_signed_segmented_direct.sv"

module InnerPESignedSegmentedDirect #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
    ...
    for (genvar h = 0; h < N_H; h++) begin : g_row
        ...
        for (genvar v = 0; v < N_W; v++) begin : g_col
            InnerTileSignedSegmentedDirect #(
...
module InnerPESignedSegmentedDirectFlat #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
