`ifndef PAYN_SIGNED_SEGMENTED_COMPENSATED_INNER_PE
`define PAYN_SIGNED_SEGMENTED_COMPENSATED_INNER_PE

`include "payn/variants/signed_segmented_compensated/inner_tile_signed_segmented_compensated.sv"

module InnerPESignedSegmentedCompensated #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
...
module InnerPESignedSegmentedCompensatedFlat #(
    parameter int K = 8,
    parameter int M = 16,
    parameter int N_H = 9,
    parameter int N_W = 9,
    ...
    InnerPESignedSegmentedCompensated #(
