`ifndef PAYN_SIGNED_SEGMENTED_CSA_ARRAY
`define PAYN_SIGNED_SEGMENTED_CSA_ARRAY
...
// Experimental recurrent carry-save array.  acc_out_east is canonical while
// mac_en is low (including row-serial drain) and is operand-isolated to zero
// during active MAC cycles.
module payn_array_signed_segmented_csa #(
