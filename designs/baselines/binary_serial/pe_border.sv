...
`include "baselines/binary_serial/ireg_border.sv"
`include "baselines/binary_serial/wreg.sv"
`include "baselines/binary_serial/mul_border.sv"
`include "baselines/binary_serial/acc.sv"
