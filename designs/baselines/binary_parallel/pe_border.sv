...
`include "baselines/binary_parallel/ireg_border.sv"
`include "baselines/binary_parallel/wreg.sv"
`include "baselines/binary_parallel/mul_border.sv"
`include "baselines/binary_parallel/acc.sv"
